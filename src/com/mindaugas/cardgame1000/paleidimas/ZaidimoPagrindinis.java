...
import com.mindaugas.cardgame1000.pirminiaiduomenys.Dalintojas;
import com.mindaugas.cardgame1000.pirminiaiduomenys.KortuVertes;
import com.mindaugas.cardgame1000.pirminiaiduomenys.Zaidejai;
import com.mindaugas.cardgame1000.veiksmai.ArTeisingaKorta;
...
import com.mindaugas.cardgame1000.veiksmai.Statymai;
            ...
            if (p1.getBet() > p2.getBet()) {
                ...
                do {
                    while (count == 1 && p1.getSetOfCards().size() > 0){
                        ...
                        glass = zl1.formuleKortai1(p1.getName(), p2.getName(), p1.getSetOfCards(), p2.getSetOfCards(), firstplcard, secondplcard);
                    ...
                    while (count == 2 && p2.getSetOfCards().size() > 0) {
                        ...
                        glass = zl1.formuleKortai2(p2.getName(), p1.getName(), p2.getSetOfCards(), p1.getSetOfCards(), firstplcard, secondplcard);
