...
import com.mindaugas.cardgame1000.paleidimas.ZaidimoPagrindinis;
...
//        Sistemoutprintas.out.println(p1Name + " your cards are:");
//        Sistemoutprintas.out.println(l1);

        System.out.println("Player two set your name: ");
        String p2Name = manoSkaneris.nextLine();
//        p2.setName((p2Name));
//        Sistemoutprintas.out.println(p2Name + " your cards are:");
//        Sistemoutprintas.out.println(l2);
